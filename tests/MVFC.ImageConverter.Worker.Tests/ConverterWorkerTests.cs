...
public class ConverterWorkerTests
{
    ...
    [Fact]
    public async Task ConverterWorker_Endpoints_ShouldRespondCorrectly()
    {
        // Arrange
        ...
        (await getResponse.Content.ReadAsStringAsync()).Should().Be("mvfc-image-converter-worker ok");
