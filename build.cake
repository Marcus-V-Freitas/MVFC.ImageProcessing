    ...
    .Does(() =>
{
    ...
    var exitCode = StartProcess("dotnet", "restore MVFC.ImageProcessing.slnx");
    ...
    .Does(() =>
{
    ...
    var exitCode = StartProcess("dotnet", "build MVFC.ImageProcessing.slnx --configuration Release --no-restore");
    ...
    .Does(() =>
{
    ...
    var testArgs = "test MVFC.ImageProcessing.slnx --configuration Release --no-build --logger \"trx\"";
    ...
    var rgCode = StartProcess(rgPath, $"-reports:\"{reportArgs}\" -targetdir:\"{reportDir}\" -reporttypes:\"Html;Cobertura;MarkdownSummaryGithub\" -assemblyfilters:\"+MVFC.Image*;-*Tests\" -classfilters:\"-*.Tests.*;-*.Playground.*\"");
